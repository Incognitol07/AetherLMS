...
class Admin(Base):
    ...
    id = Column(UUID(as_uuid=True), ForeignKey("users.id", ondelete="CASCADE"), nullable=False, unique=True, primary_key=True,index=True, comment="Unique reference to the user account")
