    ...
    async with SessionLocal() as db:
        try:
            ...
            permissions = [
                ...
                Permission(name="manage_instructors"),
                Permission(name="manage_students"),
            ...
            roles[1].permissions = [perm for perm in permissions if perm.name not in ["manage_roles", "manage_admins"]]  # admin has most permissions
            roles[2].permissions = [perm for perm in permissions if perm.name in ["view_reports", "manage_content", "manage_comments"]]  # moderator has limited permissions
